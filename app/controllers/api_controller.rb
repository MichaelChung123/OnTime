class ApiController < ApplicationController
    ...
    def timeoff_request_accept
        current_request_id = Timeoffrequest.find(params[:_json])
        current_request_id.update!(
            accepted: true
        )
    end

    def timeoff_request_decline
        current_request_id = Timeoffrequest.find(params[:_json])
        current_request_id.destroy
    end
end
